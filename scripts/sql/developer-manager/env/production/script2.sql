--Run this script on prd databases except prd master dbs
...
SET @ROLE = 'develop_role_evl_evlos_prd'--Insert DEV Role Here

DECLARE @USER VARCHAR(250)
SET @USER = 'develop_user_evl_evlos_prd'--Insert DEV User Here
...
SET @ROLE_PERMISSIONS='GRANT SELECT, INSERT, UPDATE TO ['+@ROLE +']'
...
SET @ROLE = 'manager_role_evl_evlos_prd'--Insert manager Role Here

SET @USER = 'manager_user_evl_evlos_prd'--Insert manager User Here
