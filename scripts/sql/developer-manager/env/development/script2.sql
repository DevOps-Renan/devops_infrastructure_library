...
SET @ROLE = 'develop_role_evl_evlos_dev'--Insert DEV Role Here

DECLARE @USER VARCHAR(250)
SET @USER = 'develop_user_evl_evlos_dev'--Insert DEV User Here

DECLARE @LOGIN VARCHAR(250)
SET @LOGIN = 'develop_login_evl_evlos_dev'--Insert DEV Login Here
...
SET @ROLE_PERMISSIONS='GRANT SELECT, INSERT, UPDATE, ALTER, CONTROL, DELETE TO ['+@ROLE +']'
...
SET @ROLE = 'manager_role_evl_evlos_dev'--Insert manager Role Here

SET @USER = 'manager_user_evl_evlos_dev'--Insert manager User Here

SET @LOGIN = 'manager_login_evl_evlos_dev'--Insert manager Login Here
