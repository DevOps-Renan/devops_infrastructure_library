...
SET @DATA_BASE = 'sqldb-evl-<nome_do_cliente>-prd'--Insert Data Base Here

USE [@DATA_BASE]

--Creating Role, Grating Role Permission, Creating User and Adding this User to the Role Created
DECLARE @ROLE VARCHAR(250)
SET @ROLE = 'sys_role_evl_evlos_prd'--Insert SYS Role Here

DECLARE @USER VARCHAR(250)
SET @USER = 'sys_user_evl_evlos_prd'--Insert SYS User Here
